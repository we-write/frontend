...
export { default as DefaultProfileImage } from './DefaultProfileImage.svg';
export { default as Person } from './Person.svg';
export { default as TrashCan } from './TrashCan.svg';
export { default as BtnEditLarge } from './BtnEditLarge.svg';
export { default as BtnEditSmall } from './BtnEditSmall.svg';
